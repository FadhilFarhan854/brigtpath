...
?>
    ...
    $ids = $_GET['ids'];
    $query2 = "INSERT INTO karyawan (nama_depan, nama_belakang, password, jenis_kelamin, email, no_telephone, adress, kode_pos) SELECT nama_depan, nama_belakang, password, jenis_kelamin, email, no_telephone, adress, kode_pos FROM calon_karyawan where id =$ids;";
    $query3 = "DELETE FROM `calon_karyawan` WHERE id = $ids";
